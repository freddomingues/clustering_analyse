...
def main():
    ...
    com a base de dados de 20.000 registros, gerando todas as visualizações.
    """
    ...
    labels_dict_full = {'K-Means': labels_kmeans, 'DBSCAN': labels_dbscan}
    ...
    # Etapa 6: Visualizações PCA
    print("\n--- Gerando visualizações PCA dos clusters ---")
    ...
    # Análise de Perfil Numérico K-Means
    ...
    # Análise de Perfil Categórico K-Means
    ...
    # Análise de Perfil Hierárquico (Amostra)
